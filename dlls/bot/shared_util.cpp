...
// (was #include <port.h> - a CS/Steam porting header this repo doesn't have)
#include <stdio.h>
#include <string.h>
#include <wchar.h>
#include <stdarg.h>
...
// handle quoted strings specially
	...
	{
		data++;
		while (len < sizeof( s_shared_token ) - 1)	// (fixed: had an extra ')' - this file was never compiled before)
		{
			c = *data++;
